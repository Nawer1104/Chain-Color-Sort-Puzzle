...
public class Tower : MonoBehaviour
{
    ...
    private bool CheckSprites()
    {
        ...
        Type firstType = objectList[0].GetComponent<Block>().type;
        ...
        for (int i = 1; i < objectList.Count; i++)
        {
            ...
            Type currentType = objectList[i].GetComponent<Block>().type;
            ...
            if (currentSpriteRenderer.sprite != firstSprite || currentType != firstType || type != firstType)
            {
